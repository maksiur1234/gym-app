    ...
    <div id="faq" class="container mx-auto px-5 md:w-4/5">
        <section class="py-16 pt-18">
            <div class="w-4/5 md:w-3/5 mx-auto">
                <h2 class="text-3xl md:text-4xl font-theme-heading font-medium text-center">Najczęściej zadawane pytania</h2>
                <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">Tutaj znajdziecie najczęsiej zadawane pytania oraz odpowiedzi. Jeżeli masz jakiekolwiek inne pytania zapytaj nas wysyłając wiadomość email na adres: help@gymapp.com</p>
            </div>
            ...
            <div class="mt-10 w-full lg:w-3/5 mx-auto">
                ...
                <div class="flex justify-center mt-10">
                    <LinkButton btn-type="primary" link="#" class="text-sm">Więcej pytań</LinkButton>
                </div>
            </div>
        </section>
    </div>
