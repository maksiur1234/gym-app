    ...
    <div id="features" class="container mx-auto px-5">
        <section class="py-16">
            <div class="w-4/5 md:w-3/5 mx-auto">
                <h2 class="text-3xl md:text-4xl font-semibold font-theme-heading text-center">Możliwości</h2>
                <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">Dzięki GymApp możesz kontrolować swój trening korzystając z atlasu ćwiczeń, poradników, porad trenerskich i wiele więcej.</p>
            </div>
